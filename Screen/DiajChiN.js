...
const diaChi = [
    {
        name: 'GO! AN LẠC',
        des: '1231 Quốc Lộ 1A, khu phố 5 , phường Bình Trị Đông B , Quận Bình Tân, TP.Hồ Chí Minh(Gần vòng xoay An Lạc)',
        location: 'Miễn phí giao hàng trong bán kính 7km'
    },
    {
        name: 'GO! GÒ VẤP',
        des: '792 Nguyễn Kiệm, phường 3 , quận Gò Vấp , TP.Hồ Chí Minh(Ngã sáu Gò Vấp)',
        location: 'Miễn phí giao hàng trong bán kính 7km'
    },
    {
        name: 'BigC MIỀN ĐÔNG',
        des: 'số 268 Tô Hiến Thành, Phường 15, Quận 10, tp.Hồ Chí Minh(ngã ba Tô Hiến Thành - Sư Vạn Hạnh)',
        location: 'Miễn phí giao hàng trong bán kính 7km'
    },
]
export default function DiaChiN({ navigation }) {
    ...
    return (
        ...
        <View style={{ backgroundColor: '#f8f4f4' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ backgroundColor: 'red',height: 30, width: 110, alignItems: 'center', justifyContent: 'center', borderColor: 'red', borderWidth: 1, borderTopRightRadius: 5, borderBottomRightRadius: 5 }}>
                    <Text style={{ color: "white" }}>Miền Nam</Text>
                </View>
                </Pressable>
            </View>
