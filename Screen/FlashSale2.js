...
export default function FlashSale2({ navigation }) {
    ...
    return (
        ...
        <View style={{ backgroundColor: '#FBF0DE' }}>
            ...
            <View style={{ flexDirection: 'row', borderBottomWidth: 3, borderColor: '#ea1616' }}>
                ...
                <Pressable style={{ backgroundColor: '#ea1616', alignItems: 'center', justifyContent: 'center', height: 50, borderRadius: 8, marginLeft: 10 }} onPress={() => { navigation.navigate("FlashSale2") }}>
